...
// UPDATED for ESP-IDF v5: Using standard ADC_CHANNEL_x naming instead of ADC1_CHANNEL_x
#define PSX_ADCL_LEFTRIGHT_CH		ADC_CHANNEL_3
#define PSX_ADCL_UPDOWN_CH			ADC_CHANNEL_4

#define PSX_ADCR_LEFTRIGHT_CH		ADC_CHANNEL_6
#define PSX_ADCR_UPDOWN_CH			ADC_CHANNEL_7
